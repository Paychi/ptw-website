	...
	<script>
        $(document).ready(function(){
            $('#SanRamonLasVallas').click(function(){
                alert('Diste Click a SanRamonLasVallas');

            });

            $('#VallasElPastal').click(function(){
                alert('Diste Click a VallasElPastal');

            });

            $('#Kaskita').click(function(){
                alert('Diste Click a Kaskita');

            });

            $('#VallasCentral').click(function(){
                alert('Diste Click a VallasCentral');

            });

            $('#ZinicaUno').click(function(){
                alert('Diste Click a ZinicaUno');

            });

            $('#Waslala').click(function(){
                alert('Diste Click a Waslala');

            });

            $('#SantaMariaKubali').click(function(){
                alert('Diste Click a SantaMariaKubali');

            });

            $('#BuenosAiresKubali').click(function(){
                alert('Diste Click a BuenosAiresKubali');

            });

            $('#GuayaboKubali').click(function(){
                alert('Diste Click a GuayaboKubali');

            });

            $('#KubaiCentral').click(function(){
                alert('Diste Click a KubaiCentral');

            });

            $('#PiedrasBlancas').click(function(){
                alert('Diste Click a PiedrasBlancas');

            });

            $('#SectorKum').click(function(){
                alert('Diste Click a SectorKum');

            });

            $('#LasDelicias').click(function(){
                alert('Diste Click a LasDelicias');

            });

            $('#NaranjoArriba').click(function(){
                alert('Diste Click a NaranjoArriba');

            });

            $('#WaslalitaElNaranjo').click(function(){
                alert('Diste Click a WaslalitaElNaranjo');

            });

            $('#AguasCalientes').click(function(){
                alert('Diste Click a AguasCalientes');

            });

            $('#ElNaranjo').click(function(){
                alert('Diste Click a ElNaranjo');

            });

            $('#LasTorrez').click(function(){
                alert('Diste Click a LasTorrez');

            });

            $('#LosMilagros').click(function(){
                alert('Diste Click a LosMilagros');

            });

            $('#LasNuevesDos').click(function(){
                alert('Diste Click a LasNuevesDos');

            });

            $('#LasNuevesUno').click(function(){
                alert('Diste Click a LasNuevesUno');

            });

            $('#ElPijibay').click(function(){
                alert('Diste Click a ElPijibay');

            });

            $('#ElPuyus').click(function(){
                alert('Diste Click a ElPuyus');

            });

            $('#ElKiawa').click(function(){
                alert('Diste Click a ElKiawa');

            });

             $('#Sofana').click(function(){
                alert('Diste Click a Sofana');

            });

             $('#BuenosAiresDudu').click(function(){
                alert('Diste Click a BuenosAiresDudu');

            });

             $('#Dipina').click(function(){
                alert('Diste Click a Dipina');

            });

             $('#CanoSucio').click(function(){
                alert('Diste Click a CanoSucio');

            });

             $('#SnAntonioYaro').click(function(){
                alert('Diste Click a SnAntonioYaro');

            });

             $('#YaroCentral').click(function(){
                alert('Diste Click a YaroCentral');

            });

             $('#SnJuanYaro').click(function(){
                alert('Diste Click a SnJuanYaro');

            });

             $('#OcoteTuma').click(function(){
                alert('Diste Click a OcoteTuma');

            });

             $('#ChileTres').click(function(){
                alert('Diste Click a ChileTres');

            });

             $('#OcoteYaosca').click(function(){
                alert('Diste Click a OcoteYaosca');

            });

             $('#VallasAbajo').click(function(){
                alert('Diste Click a VallasAbajo');

            });

             $('#SnPedroLasVallas').click(function(){
                alert('Diste Click a SnPedroLasVallas');

            });

             $('#SnRafaelKum').click(function(){
                alert('Diste Click a SnRafaelKum');

            });

             $('#SnFranciscoPtoViejo').click(function(){
                alert('Diste Click a SnFranciscoPtoViejo');

            });


             $('#GuayaboAbajo').click(function(){
                alert('Diste Click a GuayaboAbajo');

            });

             $('#LaLimonera').click(function(){
                alert('Diste Click a LaLimonera');

            });

             $('#LasJawas').click(function(){
                alert('Diste Click a LasJawas');

            });

             $('#Kusuli').click(function(){
                alert('Diste Click a Kusuli');

            });

             $('#SanBenito').click(function(){
                alert('Diste Click a SanBenito');

            });

             $('#StaRosaDudu').click(function(){
                alert('Diste Click a StaRosaDudu');

            });

             $('#ZapoteDudu').click(function(){
                alert('Diste Click a ZapoteDudu');

            });

             $('#ArenasBlancas').click(function(){
                alert('Diste Click a ArenasBlancas');

            });

             $('#CeibaDudu').click(function(){
                alert('Diste Click a CeibaDudu');

            });

             $('#OcoteDudu').click(function(){
                alert('Diste Click a OcoteDudu');

            });

             $('#SnMiguelDudu').click(function(){
                alert('Diste Click a SnMiguelDudu');

            });

             $('#ElSombrero').click(function(){
                alert('Diste Click a ElSombrero');

            });

             $('#SnPabloLasVallas').click(function(){
                alert('Diste Click a SnPabloLasVallas');

            });

             $('#LasFlores').click(function(){
                alert('Diste Click a LasFlores');

            });

             $('#LaPosolera').click(function(){
                alert('Diste Click a LaPosolera');

            });

             $('#ElCipres').click(function(){
                alert('Diste Click a ElCipres');

            });

             $('#HierbaBuena').click(function(){
                alert('Diste Click a HierbaBuena');

            });

             $('#ChileUno').click(function(){
                alert('Diste Click a ChileUno');

            });

             $('#ChileDos').click(function(){
                alert('Diste Click a ChileDos');

            });

             $('#ElAchioteWaslala').click(function(){
                alert('Diste Click a ElAchioteWaslala');

            });

             $('#ElCorozal').click(function(){
                alert('Diste Click a ElCorozal');

            });

             $('#LosPotrerios').click(function(){
                alert('Diste Click a LosPotrerios');

            });

             $('#CanoDeLosMartinez').click(function(){
                alert('Diste Click a CanoDeLosMartinez');

            });

             $('#Waslalita').click(function(){
                alert('Diste Click a Waslalita');

            });

             $('#CanoLaCeiba').click(function(){
                alert('Diste Click a CanoLaCeiba');

            });

             $('#CiudadWaslala').click(function(){
                alert('Diste Click a CiudadWaslala');

            });

             $('#PapayoDos').click(function(){
                alert('Diste Click a PapayoDos');

            });

             $('#BarrialColorado').click(function(){
                alert('Diste Click a BarrialColorado');

            });

             $('#ElGuabo').click(function(){
                alert('Diste Click a ElGuabo');

            });

             $('#GuayaboArriba').click(function(){
                alert('Diste Click a GuayaboArriba');

            });

             $('#ZincaDos').click(function(){
                alert('Diste Click a ZincaDos');

            });

             $('#OcoteKubali').click(function(){
                alert('Diste Click a OcoteKubali');

            });

             $('#ElBarillal').click(function(){
                alert('Diste Click a ElBarillal');

            });

             $('#LosMangos').click(function(){
                alert('Diste Click a LosMangos');

            });

             $('#PtoViejo').click(function(){
                alert('Diste Click a PtoViejo');

            });

             $('#SanPabloKubali').click(function(){
                alert('Diste Click a SanPabloKubali');

            });

             $('#EsperanzaKubali').click(function(){
                alert('Diste Click a EsperanzaKubali');

            });

             $('#BocaDePiedra').click(function(){
                alert('Diste Click a BocaDePiedra');

            });

             $('#ElGarrobo').click(function(){
                alert('Diste Click a ElGarrobo');
        ...
        <svg width="800" height="720" style="margin-left:25%;" >
          ...
          <polygon class="Municipio" id="Waslala"
           ...
           <polygon class="Municipio" id="SantaMariaKubali"
            ...
            <polygon class="Municipio" id="ZincaDos"
