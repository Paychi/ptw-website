      ...
      <!--<img src="img\SegundaWaslala.png" alt="" usemap="#map" style="position:absolute;z-index:-1;"/>-->
		...
		<svg viewBox="0 0 800 720" preserveAspectRatio="xMinYMin" style="margin-left:5%;" >
          ...
          <polygon class="Municipio" id="ZinicaUno"
                    ...
                    <image class="imgZinicaUno" x="128" y="210" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
          ...
          <polygon class="Municipio" id="Waslala"
                    points="124,239  123,263  124,269  133,285  134,299  133,307  129,315  140,316  151,322  161,328  170,322  178,326  187,324 
                     ...
                     <image class="imgWaslala"  x="135" y="270" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
           ...
           <polygon class="Municipio" id="SantaMariaKubali"
            ...
            <polygon class="Municipio" id="GuayaboKubali"
             ...
             <polygon class="Municipio" id="KubaiCentral"
                      points="239,162  232,165  214,163  200,162  194,157  185,167  181,172  193,194  197,205  211,210  224,217  239,217
                       ...
                       <image class="imgKubaiCentral" x="205" y="172" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="PiedrasBlancas"
                      points="243,101  252,83  256,85  262,85  265,82  269,88  276,85  279,88  291,84  301,96  317,104  327,111  334,121
                       ...
                       <image class="imgPiedrasBlancas" x="265" y="95" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="SectorKum"
              ...
              <polygon class="Municipio" id="LasDelicias"
                      points="379,16   375,29  366,31  366,39  360,44  359,61  360,67  366,73  367,78  381,90  387,91  392,86  397,71  
                        ...
                        <image class="imgLasDelicias" x="370" y="35" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="WaslalitaElNaranjo"
                    points="439,16  431,28  434,31  433,39  439,45  451,47  462,48  472,43  476,43  487,31  496,24  490,15  
                      ...
                      <image class="imgWaslalitaElNaranjo" x="445" y="10" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="LasTorrez"
                     points="463,91  443,85  432,76  403,63  398,64  396,76  392,87  386,91  397,98  403,101  414,109  426,113  
                      ...
                      <image class="imgLasTorrez" x="408" y="77" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="ElPijibay"
                       ...
                       <image class="imgElPijibay" x="445" y="155" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="ElPuyus"
                        ...
                        <image class="imgElPuyus" x="495" y="227" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}" />
              ...
              <polygon class="Municipio" id="ElKiawa"
                      points="486,217  480,215  465,201  443,199  431,205  426,203    423,207   421,221  409,230  422,242  432,246  440,256  
                          ...
                          <image class="imgElKiawa" x="440" y="215" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>                          
              ...
              <polygon class="Municipio" id="Sofana" 
                      points="523,273   510,264   500,261   493,253   481,255   461,279    457,270   439,256   428,277   429,285  
                        ...
                        <image class="imgSofana" x="462" y="275" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="Dipina"
                      points="511,425  496,419  455,419  450,411  441,419  423,410  393,412  403,415  412,423  410,446  401,457 
                       ...
                       <image class="imgDipina" x="445" y="460" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="YaroCentral"
                      ...
                      <image class="imgYaroCentral" x="337" y="600" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="OcoteTuma"
                      ...
                      <image class="imgOcoteTuma" x="270" y="575" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="ChileTres"
                      points="233,525  231,537  227,536  218,524  195,522  182,525  160,520  154,532  154,549  175,582  199,611 
                       ...
                       <image class="imgChileTres" x="190" y="550" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="OcoteYaosca" 
               ...
               <polygon class="Municipio" id="VallasAbajo"
                       points="106,466  111,459  109,452  116,446  113,438  106,438  105,434  102,431  98,428  95,419  91,421  85,424 
                        ...
                        <image class="imgVallasAbajo" x="75" y="440" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="SnPedroLasVallas"
                       points="53,451  67,451  70,443  79,436  92,422  94,419  96,403  96,394  91,390  85,394  42,410  34,410 
                        ...
                        <image class="imgSnPedroLasVallas" x="50" y="406" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="SnRafaelKum" 
                       points="360,67  355,72  342,80  333,80  328,87  318,91  317,105  328,111  336,122  355,129  366,136 
                        ...
                        <image class="imgSnRafaelKum" x="340" y="85" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
              ...
              <polygon class="Municipio" id="SnFranciscoPtoViejo"
                       ...
                       <image class="imgSnFranViejo" x="315" y="130" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="Kusuli" 
                       ...
                       <image class="imgKusuli" x="269" y="317" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="SanBenito"
                       ...
                       <image class="imgSanBenito" x="320" y="320" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="ZapoteDudu"
                      ...
                      <image class="imgZapoteDudu" x="380" y="355" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="ArenasBlancas" 
                     ...
                     <image class="imgArenasBlancas" x="360" y="413" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="CeibaDudu"
                      ...
                      <image class="imgCeibaDudu" x="368" y="497" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
             ...
             <polygon class="Municipio" id="OcoteDudu" 
                     ...
                     <image class="imgOcoteDudu" x="290" y="515" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
            ...
            <polygon class="Municipio" id="SnPabloLasVallas" 
                    ...
                    <image class="imgSnPabloVallas" x="95" y="403" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
            ...
            <polygon class="Municipio" id="ChileDos" 
                    ...
                    <image class="imgChileDos" x="225" y="490" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
            ...
            <polygon class="Municipio" id="ElGuabo" 
                     ...
                     <image class="imgElGuabo" x="255" y="360" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
            ...
            <polygon class="Municipio" id="PtoViejo" 
                    points="409,184  412,169  423,175  430,175  438,137  421,126  413,128  399,120  379,120  373,130  365,135  370,141  372,161 
                     ...
                     <image class="imgPtoViejo" x="385" y="130" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
            ...
            <polygon class="Municipio" id="ElGarrobo" 
                    points="358,299  361,311  358,325  369,329  379,322  382,326  422,323  429,327  436,315 
                      ...
                      <image class="imgElGarrobo" x="380" y="290" width="30" height="30" xlink:href="{{ asset('/img/celular.png') }}"/>
