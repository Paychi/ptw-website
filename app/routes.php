...
//Obtiene la Información de las comunidades para el mapa
Route::post('Comunidad/GetInfoComunidad', 'ComunidadController@GetInfoComunidad');
Route::post('Comunidad/ImagenesAMostrar', 'ComunidadController@ImagenesAMostrar');
